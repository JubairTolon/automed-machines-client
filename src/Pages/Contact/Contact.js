        ...
        <div className='mt-32 grid grid-cols-1 lg:grid-cols-2'>
            ...
            <div className='w-1/2 mx-auto'>
                ...
                <form>
                    ...
                    <button type="submit" class="text-white bg-orange-500 hover:bg-orange-400 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send</button>
                </form>
            </div>
        </div >
    );
