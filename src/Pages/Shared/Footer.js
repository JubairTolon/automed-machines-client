            ...
            <footer className='footer p-10'>
                <div className='grid grid-flow-row grid-cols-2 items-center justify-between w-full'>
                    <div className='mx-auto'>
                        ...
                        <h3 className='lg:text-xl text-md my-8'>Sign up aur newsleter today. Also get alarts for new product.</h3>
                    </div>
                    <div className="relative  mx-auto">
                        <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <span className='text-xl text-gray-300'><MdEmail /></span>
                        </div>
                        <form onSubmit={handleSubscription}>
                            <input name='email' type="email" className="block p-4 pl-10 w-72  lg:w-96 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="Enter your email..." required />
                            <button type="submit" className="text-white absolute right-2.5 bottom-2.5 bg-orange-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Subscribe</button>
                        </form>
                    </div>
                </div>
            </footer >
