...
const BusinsessSummary = () => {
    return (
        <div className='mx-auto w-full bg-gray-100 py-10'>
            ...
            <Slide bottom>
                <div className='w-full grid grid-flow-col grid-rows-2 gap-10 lg:gap-0 lg:grid-rows-1  justify-around mx-auto my-12'>
                    <div className='flex flex-col'>
                        ...
                        <p className='text-orange-500 mt-4 md:mt-1 uppercase'>Shipments</p>
                    </div>
                    <div className='flex flex-col'>
                        ...
                        <p className='text-orange-500 mt-4 md:mt-1 uppercase'>Country</p>
                    </div>
                    <div className='flex flex-col'>
                        ...
                        <p className='text-orange-500 mt-4 md:mt-1 uppercase'>Happy Client</p>
                    </div>
                    <div className='flex flex-col'>
                        ...
                        <p className='text-orange-500 mt-4 md:mt-1 uppercase'>feedbacks</p>
                    </div>
                </div>
            </Slide>
