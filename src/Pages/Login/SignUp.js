        ...
        <div className='mt-48 lg:mt-32'>
            <div className='w-2/3 lg:w-1/3 grid grid-rows-1 Justify-center items-center mx-auto border border-gray-400 rounded mt-36 p-16'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button type="submit" value="Login" className="text-white bg-orange-500 hover:bg-orange-400 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign up</button>
                </form>
                <p className='mt-4'><small className='text-gray-600'>Already have an account ? <Link className='text-primary' to='/login'>Please login</Link></small></p>
