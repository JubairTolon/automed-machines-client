            ...
            <div className='w-5/6 mx-auto grid grid-cols-1 lg:grid-cols-2 mt-40'>
                ...
                <div className=''>
                    ...
                    <div className="flex gap-4 items-center my-4">
                        <span className="text-xl font-bold text-gray-900 dark:text-white">$ {product[0]?.price}</span>
                        {
                            product[0]?.offer &&
            ...
            <div className='w-2/3 grid grid-cols-1 lg:grid-cols-2 mx-auto mt-16'>
                <div>
                    ...
                    {reviews && (
                        <div>
                            <div className='w-2/3'>
                                <figure className="flex flex-col justify-center items-center p-8 text-center bg-white border-2 rounded dark:bg-gray-800 dark:border-gray-700">
                                    <blockquote className="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-gray-400">
                                        <Rating name="half-rating" value={product[0].rating} precision={0.5} readOnly />
                                        <p className="my-4 font-light">{product[0].review}</p>
                                    </blockquote>
